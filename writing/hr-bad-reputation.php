...
<section class="section wrap-article" style="border-top:none;">
    <div class="prose dropcap">
        ...
        <p>No HR professional I know lies awake at night working out which policy will make an employee's life harder. Policies exist to explain complicated legal processes in simple terms and to set expectations that would otherwise be argued over case by case. Some of them are long because the underlying law is long, and some of them are long because the law specifically requires certain wording to appear. None of that is a preference. It's a compliance minimum.</p>
        <p>I'll grant the other side of this, though. Plenty of policies genuinely do gather dust. A company bidding for public sector work, or chasing an accreditation it needs to trade, will often be asked to produce a modern slavery statement or an environmental policy as a condition of entry. Those get drafted, reviewed once a year, and otherwise sit untouched. I understand why that looks like box ticking to a director watching the invoice land, because in a narrow sense it is. But that's a criticism of the accreditation system, not of the person who had to write the document to satisfy it.</p>
        <p>Where the criticism really falls apart is on the policies that keep a business out of tribunal, and those are the ones getting harder to ignore. Claims are up, driven partly by press coverage of employment rights since the election and partly by people using AI to help build a case, which brings its own risk given how often that advice turns out to be wrong. The Fair Work Agency is still a young organisation, but it's about to start spot checking, and it's checking things most directors have never thought about. Working hours and holiday have to be recorded for every employee, every week. Minimum wage compliance isn't just about the rate of pay, because fifteen unpaid minutes over the week is a breach, and a breach is a criminal offence, not a something you can negotiate away. From 1 October, that same criminal exposure extends to a contractor's staff a company has never employed directly, a cleaner working through an agency being the obvious example.</p>
